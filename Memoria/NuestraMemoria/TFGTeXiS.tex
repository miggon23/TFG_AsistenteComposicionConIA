...
\usepackage{float} % Paquete necesario para [H]
...
\include{Capitulos/ManualDeUsuario}
\include{Capitulos/GeneracionMusical}
\include{Capitulos/ArmonizacionMusical}
\include{Capitulos/BusquedaNuevosColores}
\include{Capitulos/GeneracionPercusion}
\include{Capitulos/Sonorizacion}
\include{Capitulos/ComoArreglarUnaCancion}
%\include{Capitulos/GUIconTKInter}
