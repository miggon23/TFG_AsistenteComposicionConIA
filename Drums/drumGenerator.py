...
class DrumGenerator:
    def generate(style):
        ...
        oldMidiUtils.write_midi_song_drums("./Media/midi/output_"+style.name+"_drumPatternA.mid", drumPatternA)
        oldMidiUtils.write_midi_song_drums("./Media/midi/output_"+style.name+"_drumPatternB.mid", drumPatternB)
        oldMidiUtils.write_midi_song_drums("./Media/midi/output_"+style.name+"_drumPatternC.mid", drumPatternC)
