...
\subsection{Heurística}\label{sec:arm:heuristica}
...
\subsection{Armonización por ventanas de diferentes tamaños}\label{arm:subsubsec:ventanas_diferentes}
